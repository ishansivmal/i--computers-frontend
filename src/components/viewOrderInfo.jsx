          ...
          <div className="space-y-3 mb-4">
            ...
            <div className="flex flex-row justify-between items-center">
              ...
              <select
                ...
                className="border border-gray-300 rounded-md p-1 bg-amber-200"
              >
          ...
          <div className="m-1.5 gap-1">
            {(order.notees !== notes ||
              ...
              <button
                ...
                className="mb-1.5 w-full bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-all"
              >
                Save changes
              </button>
            )}
